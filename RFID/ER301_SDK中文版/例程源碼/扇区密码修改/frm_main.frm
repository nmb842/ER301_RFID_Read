...
Begin VB.Form frm_main 
   ...
   Begin VB.ComboBox Combo_Sector 
      Height          =   360
      Left            =   3000
      TabIndex        =   27
      Text            =   "Combo1"
   ...
   Begin VB.Label Label7 
      Caption         =   "Click Request before this button"
      Height          =   495
      Left            =   9360
      TabIndex        =   29
      Top             =   7080
...
Option Explicit
' click request button before run this button
...
Next i
m = (Combo_Sector.ListIndex) * 4 + 3 ' compute the key block
If (m = -1) Then
...
s1 = Trim(txt_NewKeyA.Text) + Trim(txt_ACB.Text) + Trim(txt_NewKeyB.Text)  'Combo the 3 part into one block data
If (Len(s1) <> 32) Then
    lb_info.Caption = "Wrong Data length "
    txt_NewKeyA.SetFocus
    Exit Sub
End If
For i = 0 To 15
...
lb_info.Caption = "Write Sector KEY Succeed!"
...
Next i
For i = 0 To 15
    Combo_Sector.AddItem CStr(i), i   ' sector block
Next i
  
cb_ckh.ListIndex = 2: cb_btl.ListIndex = 3: cb_kh.ListIndex = 4: Combo_Sector.ListIndex = 1
End Sub
